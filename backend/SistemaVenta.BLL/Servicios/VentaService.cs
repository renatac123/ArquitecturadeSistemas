...
namespace SistemaVenta.BLL.Servicios
{
    public class VentaService: IVentaService
    {
        ...
        public VentaService(IGenericRepository<DetalleVenta> detalleVentaRepositorio, IVentaRepository _ventaRepositorio, IMapper mapper)
        {
            _detalleVentaRepositorio = detalleVentaRepositorio;
            _ventaRepositorio = _ventaRepositorio;
            _mapper = mapper;
        }
        ...
        public async Task<List<VentaDTO>> Historial(string buscarPor, string numeroVenta, string fechaInicio, string fechaFin)
        {
            ...
            try
            {
                ...
                else //SI NO ES POR FECHA, QUE BUSQUE POR NUMERO DE DOCUMENTO
                {
